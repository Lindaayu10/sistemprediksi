...
<body id="page-top">
  ...
  <!-- End of Topbar -->
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">
            <a href="<?php echo site_url('admin/Admin_dataguru') ?>"><i class="fas fa-arrow-left"></i> Back</a>
          </h6>
        </div>
        <div class="card-body">
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
      ...
      <tbody>
    <form action="<?php base_url('admin/Admin_dataguru') ?>" method="post" enctype="multipart/form-data" >
<div class="container">
<div class="row">
  <div class="col-md-4">
      ...
      <div class="form-group">
        ...
        <input class="form-control <?php echo form_error('nama_guru') ? 'is-invalid':'' ?>"
         type="text" name="nama_guru" placeholder="nama guru" />
        <div class="invalid-feedback">
