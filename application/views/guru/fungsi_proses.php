...
//    if($_SESSION['kepribadian_naive_bayes_level']==2 & ($menu=='klasifikasi')){// || $menu=='view_rule')){
  //      return true;
    ...
    //if($_SESSION['kepribadian_naive_bayes_level']==1 & (($menu=='data_latih')
      //       || ($menu=='uji_akurasi') || ($menu=='laporan_hasil') || ($menu=='datasiswa') || $menu=='data_soal')){
        //return true;
    //}
    //return false;
//} 

function get_id_dataadmin($db_object, $id_datasiswa){
...
function get_data_siswa($db_object, $id_datasiswa){
...
//            end_column();
//            start_column();
                    list_dataadmin($name, $value, $required, $all, $text_all, $where, $params);
//            end_column();
//	end_row();
}
