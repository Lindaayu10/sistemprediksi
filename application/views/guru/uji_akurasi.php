        ...
        <form method="post" enctype="multipart/form-data" action="<?= site_url('guru/Uji_akurasi/excel') ?>">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">
                <a href="<?php echo site_url('guru/uji_akurasi/add') ?>"><i class="fas fa-plus"></i> Add New</a>
              </h6>
            </div>
        </form>
        <form>
           <div class="form-group">
                <a href="<?= base_url('guru/uji_akurasi/naivebayes') ?>" class="btn btn-secondary active">
