    ...
    <div class="alert alert-success" role="alert">
      <?php echo $this->session->flashdata('success'); ?>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          <tbody>
	<form action="<?php base_url('admin/datasiswa') ?>" method="post" enctype="multipart/form-data" >

  <div class="container">
  <div class="row">
    <div class="col-md-5">
      <div class="form-group">
        <input class="form-control <?php echo form_error('id_datasiswa') ? 'is-invalid':'' ?>"
         name="id_datasiswa" placeholder="name" type="hidden" />
      </div>
        <div class="col-md-6">
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control <?php echo form_error('ttl') ? 'is-invalid':'' ?>"
         type="text" name="ttl" placeholder="ex: Purworejo, 10-01-2000" />
        <div class="invalid-feedback">
