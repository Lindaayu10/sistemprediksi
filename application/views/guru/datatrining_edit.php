...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div class="sidebar-brand-text mx-3"><img src="<?= base_url() ?>assets/img/" width="200px" height="50px"></div>
      </a>
  ...
  <!-- Dropdown - User Information -->
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
              <a href="<?php echo site_url('guru/datatrining/edit') ?>"><i class="fas fa-arrow-left"></i> Back</a>
            </h6>
          </div>
        <div class="card-body">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
<form action="<?php base_url("guru/datatrining_edit") ?>" method="post" enctype="multipart/form-data" >
<div class="container">
<div class="row">
  <div class="col-md-4">
  <input type="hidden" name="id_datatrining" value="<?php echo $datatrining->id_datatrining ?>" />
      <div class="form-group">
        <input class="form-control <?php echo form_error('id_datatrining') ? 'is-invalid':'' ?>"
         name="id_datatrining" placeholder="name" type="hidden" />
      </div>
      <div class="col-md-6">
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control <?php echo form_error('jenkel') ? 'is-invalid':'' ?>"
         type="text" name="jenkel" placeholder="jenis kelamin" />
        <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <input class="form-control <?php echo form_error('pengetahuan') ? 'is-invalid':'' ?>"
         type="text" name="pengetahuan" placeholder="nilai pengetahuan" />
        <div class="invalid-feedback">
      ...
      <div class="form-group">
        ...
        <input class="form-control <?php echo form_error('ketrampilan') ? 'is-invalid':'' ?>"
         type="text" name="ketrampilan" placeholder="nilai ketrampilan" />
        <div class="invalid-feedback">
      ...
      <div class="form-group">
          ...
          <input class="form-control <?php echo form_error('spiritual') ? 'is-invalid':'' ?>"
           type="text" name="spiritual" placeholder="nilai_spiritual" />
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <input class="form-control <?php echo form_error('sosial') ? 'is-invalid':'' ?>"
           type="text" name="sosial" placeholder="nilai sosial" />
          <div class="invalid-feedback">
            <?php echo form_error('sosial') ?>
          </div>
        </div>
        <div class="form-group">
          <label for="name">Predikat Asli*</label>
          <input class="form-control <?php echo form_error('predikat_asli') ? 'is-invalid':'' ?>"
           type="text" name="predikat_asli" placeholder="predikat asli" />
          <div class="invalid-feedback">
