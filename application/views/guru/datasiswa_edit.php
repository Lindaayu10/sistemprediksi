    ...
    <!-- Nav Item - User Information -->
     ...
     <!-- Dropdown - User Information -->
        ...
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
              <a href="<?php echo site_url('guru/datasiswa/edit') ?>"><i class="fas fa-arrow-left"></i> Back</a>
            </h6>
          </div>
        <div class="card-body">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
<form action="<?php base_url(" admin/datasiswa_edit") ?>" method="post" enctype="multipart/form-data" >
<div class="container">
<div class="row">
  <div class="col-md-4">
  <input type="hidden" name="id_datasiswa" value="<?php echo $datasiswa->id_datasiswa ?>" />
      ...
      <div class="form-group">
        ...
        <input class="form-control <?php echo form_error('ttl') ? 'is-invalid':'' ?>"
         type="text" name="ttl" placeholder="ttl" />
        <div class="invalid-feedback">
        ...
        <div class="form-group">
          <label for="name">Jenkel*</label>
          <input class="form-control <?php echo form_error('jenkel') ? 'is-invalid':'' ?>"
           type="text" name="jenkel" placeholder="jenkel" />
          <div class="invalid-feedback">
