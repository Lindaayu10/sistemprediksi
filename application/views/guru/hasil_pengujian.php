								...
								<table class="table table-striped">
									...
									<tbody>
										<tr>
											...
											<td><?= $predikat_hasil_sangat_baik ?></td>
											<td><?= $predikat_asli_baik ?></td>
											<td><?= round($predikat_hasil_sangat_baik / ($predikat_hasil_sangat_baik + $predikat_asli_baik) * 100) ?> %</td>
										</tr>
										<tr>
											<th scope="row">Pred Baik</th>
											<td><?= $predikat_asli_sangat_baik ?></td>
											<td><?= $predikat_hasil_baik ?></td>
											<td><?= round($predikat_asli_sangat_baik / ($predikat_asli_sangat_baik + $predikat_hasil_baik) * 100) ?> %</td>
										</tr>
										<tr>
											<th scope="row">Class Precision</th>
											<td><?= round($predikat_hasil_sangat_baik / ($predikat_hasil_sangat_baik + $predikat_asli_sangat_baik) * 100)  ?> %</td>
											<td><?= round($predikat_asli_baik / ($predikat_asli_baik + $predikat_hasil_baik) * 100) ?> %</td>
											<td>#</td>
										</tr>
									</tbody>
								</table>
