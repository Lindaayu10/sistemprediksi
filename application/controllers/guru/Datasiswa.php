...
class Datasiswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        {   
            ...
            $this->load->view("guru/datasiswa_list", $data); 
        }else{
    ...
    public function add()
    {
        ...
        $this->load->view("guru/datasiswa_new");
    }

    //mengedit data ke database
    public function edit($id_datasiswa = null)
    {
        if (!isset($id_datasiswa)) redirect('guru/datasiswa');
        ...
        $this->load->view("guru/datasiswa_edit", $data);
    }  
    ...
    public function delete($id_datasiswa = null)
    {
        ...
        if ($this->model_datasiswa->delete($id_datasiswa)) {
            redirect(site_url('guru/datasiswa'));
        }
    }
