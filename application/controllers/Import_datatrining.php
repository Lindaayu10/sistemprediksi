<?php
    ...
    class Import_datatrining extends CI_Controller {

        public function index()
        {
            $data['datatrining'] = 'Import Excel';
            $data['datatrining'] = $this->db->get('datatrining')->result();
            $this->load->view('import/index', $data);
        }

        public function create()
        {
            $data['datatrining'] = "Upload File Excel";
